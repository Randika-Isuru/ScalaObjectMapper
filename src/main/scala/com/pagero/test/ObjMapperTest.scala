...
object ObjMapperTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val cluster = Cluster.builder().addContactPoint("127.0.0.1").withPort(9043).build();
    ...
    val mapperForUdtCaseClassWithUDT = manager.mapper(classOf[TableObjectCaseClassWithUDT])

    mapperForUdtCaseClassWithUDT.save(TableObjectCaseClassWithUDT(123,UdtCaseClass(123, "Randika")))
